...
func NewSimpleServiceProcessor(handler SimpleService) *SimpleServiceProcessor {
  ...
  self23 := &SimpleServiceProcessor{handler:handler, processorMap:make(map[string]thrift.TProcessorFunction)}
  self23.processorMap["add"] = &simpleServiceProcessorAdd{handler:handler}
return self23
}
